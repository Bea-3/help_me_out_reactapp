            ...
            <div className="login-container">
                <div className="signup-loginform">
                    ...
                    <div className="login-buttons">
                        <Link className="btn-wrap-google"><div className="login-btn"><span className="google-icon"></span> <p>Continue with Google</p></div></Link>
                        <Link className="btn-wrap-facebook"><div className="login-btn"><span className="facebook-icon"></span> <p>Continue with Facebook</p></div></Link>
                    </div>
                    <div className="or-frame">
                        <div className="vector-line1"></div>
                        <div className="vector-or">or</div>
